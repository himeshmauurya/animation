...
export default function Ani() {
  ...
  function moveDiagonal() {
    positionX1.value = withTiming(
      100,
      {duration: 2000, easing: Easing.linear},
      isfinish => {
        console.log('sdkjfdl', isfinish);
        if(isfinish){
  ...
  function reset() {
    ...
    // positionX1.value = withTiming(0, {duration: 2000, easing: Easing.linear});
    // positionY1.value = withTiming(0, {duration: 2000, easing: Easing.linear});
    ...
    positionX2.value = withTiming(0, {duration: 2000, easing: Easing.linear});
    positionY2.value = withTiming(0, {duration: 2000, easing: Easing.linear});
